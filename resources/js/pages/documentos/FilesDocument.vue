                    ...
                    <tr v-for="(file, index) in archivos">
                        ...
                        <td>
                            <a :href="'/storage/' + file.path" target="_blank">
                                <i class="bi bi-download fs-5 me-1"></i>
                            </a>
                            <i class="bi bi-pencil-square text-primary fs-5 me-1" role="button" @click="edit(index)"></i>
                            <i class="bi bi-trash text-danger fs-5 me-1" role="button" @click="destroy(file.id, index)" v-if="index !== 0"></i>
                        </td>
                    </tr>
                </tbody>
            </table>
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            NProgress.configure({ parent: '#modalBody' });
