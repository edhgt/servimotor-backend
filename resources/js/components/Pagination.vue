<template>
    <div class="d-flex justify-content-between mt-2">
        ...
        <nav aria-label="Paginación" v-if="prevPageUrl || nextPageUrl">
        <ul class="pagination justify-content-end">
            <li class="page-item" :class="{'disabled': !prevPageUrl}">
            <button class="page-link" @click="handlePageChange(prevPageUrl)">Anterior</button>
            </li>
            <li class="page-item" :class="{'disabled': !nextPageUrl}">
            <button class="page-link" @click="handlePageChange(nextPageUrl)">Siguiente</button>
            </li>
        </ul>
        </nav>
    </div>
...
export default {
  ...
  props: {
    ...
    prevPageUrl: { type: [String, null], required:false, default: null },
    nextPageUrl: { type: [String, null], required:false, default: null },
  },
  emits: ['change-page'],
  setup(props, context) {
